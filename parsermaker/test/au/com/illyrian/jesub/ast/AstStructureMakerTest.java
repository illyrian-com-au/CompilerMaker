...
public class AstStructureMakerTest extends ClassMakerTestCase
{
    ...
    public void testDeclareModule() throws Exception
    {
        ...
        build.Package(new AstClassPath(auComIllyrian));
        AstClassPath import1 = build.ClassPath(AstStructure);
        AstClassPath import2 = build.ClassPath(build.Name("java.io.File"));
        build.Import(import1);
        build.Import(import2);
    ...
    public void testDeclareClass() throws Exception
    {
        ...
        AstClassPath implements1 = build.ClassPath(build.Name("AstStructure"));
        AstClassPath implements2 = build.ClassPath(build.Name("Runnable"));
        build.Implements(implements1);
        build.Implements(implements2);
    ...
    public void testDeclareVariable() throws Exception
    {
        ...
        assertEquals("Fully Qualified Class name:", "au.com.illyrian.jesub.ast.Test", maker.getFullyQualifiedClassName());
        ClassType superClass = maker.getSuperClass();
        assertEquals("Super class:", "au.com.illyrian.expressionparser.FuncABC", superClass.getName());
