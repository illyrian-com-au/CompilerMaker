...
public class CastingPrecidenceParserTest extends TestCase
{
    ...
    PrecidenceParser createShortcutParser()
    {
        // FIXME - rename precedence
        ...
        // FIXME - should be left associative
        parser.addInfixOperator("?", ExpressionAction.ORELSE, 2, Operator.SHORTCUT, false);
        parser.addInfixOperator(":", ExpressionAction.ORELSE, 2, Operator.SHORTCUT, false);
        return parser;
    }
    ...
    {
        out.println("a == b != c");
        PrecidenceParser parser = createShortcutParser();
    ...
    public void testTernaryParser1() throws Exception
    {
        out.println("a ? b : c");
        PrecidenceParser parser = createShortcutParser();
        createCompileModule(writer.toString(), parser);
