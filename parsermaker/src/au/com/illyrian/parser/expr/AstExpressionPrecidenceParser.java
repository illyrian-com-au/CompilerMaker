...
public class AstExpressionPrecidenceParser extends OperatorPrecidenceParser<AstExpression> implements ParserConstants {
        ...
        if (isTokenAnOperand()) {
            ...
            if (nud != null) {
                if ("-".equals(nud.getName()) || "+".equals(nud.getName())) {
                    ...
                    if ("byte".equals(operand) || "char".equals(operand) || "short".equals(operand)
                            || "int".equals(operand) || "long".equals(operand) || "float".equals(operand)
