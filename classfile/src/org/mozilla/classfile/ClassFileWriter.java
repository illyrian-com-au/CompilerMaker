...
public class ClassFileWriter implements ByteCode {
                           ...
                           String sourceFileName)
    {
        ...
        itsFlags = ACC_PUBLIC;
        if (DEBUGCODE) setDebugCodeOutput(System.out);
        if (isDebugCode())
     ...
     * @param slot     the slot number of the variable
     *                 or -1 if it does not have a Java register.
     * @param stopPC  the last bytecode PC where this variable is live,
                                    ...
                                    int handlerLabel, String catchClassName)
    {
        ...
        if (isDebugCode())
        	this.debugString("\t.catch " + (catchClassName == null ? "all" : catchClassName) 
...
final class ClassFileMethod
{
    ...
    int write(byte[] data, int offset)
    {
        ...
        {   // There are no attributes for this abstract method.
            offset = ClassFileWriter.putInt16(0, data, offset);
        }
        return offset;
    }
